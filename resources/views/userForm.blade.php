...
<html lang="{{ app()->getLocale() }}">
    ...
    <body>
      ...
      <div class='container'>
        <center><h2 style="bottom:2%;">Become one of our members today!</h2></center>
        ...
        <div class="col-sm-4">
           <form action="/signup" method="POST" enctype="multipart/form-data">
            ...
            <table class='table tbl-striped'>
             ...
             <tr>
                <td>Repeat Password</td><td><input type='password' class='form-control' name='password2'></td>
            </tr>
            <tr>
                <td>Email</td><td><input type='text' class='form-control' name='mail'>
            </tr>
            </table>
            <centeR><input class='btn btn-success' type='submit' name='submit' value='Sign Up!'></center>
            </form>
        </div>
        <div class="col-sm-4"></div>
        </div>
